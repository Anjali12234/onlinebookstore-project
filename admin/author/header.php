    ...
    <! -----------Navbar----------!>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse " id="navbarTogglerDemo02">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <!-- <li class="nav-item">
                            <a style="color:aliceblue" class="nav-link  " href="dashboard.php">Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a style="color:aliceblue" class="nav-link  " href="Login/alogin.php">Categories</a>
                        </li> -->
                    </ul>
        ...
        <div class="sidenav">
            ...
            <div class="dropdown-container">
                ...
                <a href="../login/alogin.php">Login</a>
            </div>
